...
A full-stack web application built with **PHP 8.x (PDO)**, **MySQL**, **HTML5**, **CSS3**, and **JavaScript** to help students discover and verify eligibility for government and private scholarships across India in real time.
...
```powershell
New-Item -ItemType SymbolicLink -Path "C:\xampp\htdocs\scholarship-finder" -Target "$HOME\Desktop\scholarship-finder"
```

#### Option B (Direct Copy):
Copy this `scholarship-finder` folder directly into:
```
C:\xampp\htdocs\scholarship-finder
```
...
👉 **[http://localhost/scholarship-finder](http://localhost/scholarship-finder)**
...
2. Go to **File ➔ Open Folder...** and select the `scholarship-finder` folder.
3. You can edit any HTML, CSS, JavaScript, or PHP file directly!
